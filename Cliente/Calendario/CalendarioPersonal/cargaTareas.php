...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    if (
        ...
        $sql = "SELECT DISTINCT t.IdTarea,t.FechaInicio,t.FechaFin,t.Descripción, r.Color FROM tareas t,tipoTarea r where t.IdPiso = " . $_SESSION["IdPiso"] . " and r.IdTipoTarea=t.IdTipoTarea and t.IdUsuario";
    } else {
